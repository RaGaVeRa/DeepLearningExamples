export OUTPUT_FOLDER=output_tacotron2_transferlearn_jp_te
export NVLOGFILE=nvlog_tacotron2_transferlearn_jp_te.json
...
TRAIN_FILELIST=etc/filelist_jp_final_filtered_train.txt
VAL_FILELIST=etc/filelist_jp_final_filtered_val.txt
